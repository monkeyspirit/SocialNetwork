...
public class MainController {
    ...
    private void initialize() throws IOException {
        ...
        graphicThread.setMainController(this);
    ...
    /**
     * Il Metodo si occupa di aggiornare gli elementi delle listview in modo che poi il thread aggiorni la main.sample
     */
    ...
    public void openNotificationView(int notificaitonIndex) throws IOException {
        ...
        FXMLLoader loaderNotify = new FXMLLoader(Main.class.getResource("view/fxml/viewNotify.fxml"));
    ...
    /**
     * Metodo per la creazione di un nuovo evento, chiama il controllers dedicato
     * @throws IOException
     */
    public void openEventView() throws IOException {

        FXMLLoader loaderEvent = new FXMLLoader(Main.class.getResource("view/fxml/viewEvent.fxml"));
    ...
    public void openEventEditor(ActionEvent actionEvent) throws IOException {
        ...
        FXMLLoader loaderCreate = new FXMLLoader(Main.class.getResource("view/fxml/createEvent.fxml"));
    ...
    public void exitUser() throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(Main.class.getResource("view/fxml/login.fxml"));
    ...
    public void openSettings() throws IOException {
        ...
        FXMLLoader loaderSettings = new FXMLLoader(Main.class.getResource("view/fxml/settings.fxml"));
